...
CREATE TABLE IF NOT EXISTS reports(
  ...
  template_id TEXT, job_id TEXT REFERENCES jobs(id) ON DELETE SET NULL,
  reason TEXT NOT NULL, detail TEXT NOT NULL, status TEXT NOT NULL DEFAULT 'open', created_at TEXT NOT NULL);
ALTER TABLE reports ADD COLUMN IF NOT EXISTS job_id TEXT REFERENCES jobs(id) ON DELETE SET NULL;
...
INSERT INTO schema_migrations VALUES(1, CURRENT_TIMESTAMP::text),(2, CURRENT_TIMESTAMP::text),(3, CURRENT_TIMESTAMP::text),(4, CURRENT_TIMESTAMP::text) ON CONFLICT(version) DO NOTHING;
